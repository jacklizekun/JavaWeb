<%@ page language="java" import="user.*" pageEncoding="GBK"%>
...
<html><head><title>坤坤购物商城会员注册</title>

<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<meta name="keywords" content="Discuz!,Board,Comsenz,forums,bulletin board,">
<meta name="description" content="坤坤论坛">
        ...
        <td background="images/bitmap.gif" height="80" valign="middle"><table align="right" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
            ...
            <td valign="middle" width="812"><div align="right">
              <a style="left: 799px ! important; top: 61px ! important;" class="abp-objtab visible" href="#"></a><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="#" height="61" width="460">
                  <param name="movie" value="#">
                  <param name="quality" value="high">
                  <embed src="images/new1.swf" quality="high" pluginspage="#" type="application/x-shockwave-flash" height="61" width="460">
              </object>
            </div></td>
            <td width="5">&nbsp;</td>
          </tr>
